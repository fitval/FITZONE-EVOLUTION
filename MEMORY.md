...
- **Reste à traiter (séance « verrouillage »)** : durcissement des règles d'accès et de la gestion des comptes, détaillé dans une note privée hors dépôt (`~/FITZONE/securite-points-ouverts.md`). Ne jamais recopier ces détails dans le dépôt, public.
