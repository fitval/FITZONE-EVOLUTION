...
-- Ce script réinstalle anon_rw_client_contracts (FOR ALL TO anon USING true) et anon_insert_payments : contrats lisibles et modifiables, paiements insérables par tous.
